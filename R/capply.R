...
#' @describeIn capply formula method for capply
#' @export
...
#' @describeIn cvar factor method for cvar
#' @export
...
#' @describeIn cvar default methods for cvar
#' @export
...
#' @rdname cvar factor method for dvar
#' @export
...
#' Transform NAs to 0
#'
#' @param x any vector for which 'is.na(x)' is valid
#' @export
na20 <- function(x) {
  x[is.na(x)] <- 0
  x
